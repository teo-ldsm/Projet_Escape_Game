...
public class Main {
    public static void main(String[] args) {
        ...
        Scene salleFlippante = new Scene("Salle Flippante", "src/resources/Salle flippante.png", "Vous êtes dans une salle flippante, vous devez trouver un moyen de sortir.");
            ...
            Objet boite2 = new Objet(573, 410, 36, 36, "Boîte", "C'est une boîte qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, false);
            Objet boite3 = new Objet(606, 656, 34, 48, "Boîte", "C'est une boîte qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, false);
