...
public class Main {
    public static void main(String[] args) {
        ...
        Scene bureauSombre = new Scene("Bureau Sombre", "src/resources/Salle sombre.png", "Un homme dans la rue vous a proposé de monter dans sa camionnette blanche pour vous donner des bonbons. Il vous a kidnappé et drogué, vous vous trouvez dans une cave sombre. Vous devez trouver un moyen d'allumer la lumière pour vous échapper.");
            Objet interrupteur = new Objet(215, 365, 130, 345, "Interrupteur", "Un interrupteur qui pourrait allumer la lumière.", true, Hitboxes.CARRE, false, false);
        ...
        Scene salleFlippante = new Scene("Salle Flippante", "src/resources/Salle flippante.png", "Vous êtes dans une salle flippante, vous devez trouver un moyen de sortir.");
            Objet lampe = new Objet(370, 400, 60, 75, "Lampe", "C'est une lampe.", false, Hitboxes.CARRE, false, false);
            Objet porte = new Objet(845, 472, 225, 700, "Porte", "C'est une porte qui mène à une autre salle.", true, Hitboxes.CARRE, false, false);
            Objet ordinateur = new Objet(270, 550, 150, 130, "Ordinateur", "C'est un ordinateur qui pourrait contenir des informations.", true, Hitboxes.CARRE, false, false);
            Objet Sac = new Objet(150, 850, 230, 180, "Sac", "C'est un sac qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, true);
            Objet journal = new Objet(240, 390, 60, 154, "Journal", "C'est un journal qui pourrait contenir des informations.", false, Hitboxes.CARRE, false, true);
            Objet boite1 = new Objet(575, 236, 70, 65, "Boîte", "C'est une boîte qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, true);
            Objet boite2 = new Objet(548, 385, 60, 76, "Boîte", "C'est une boîte qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, true);
            Objet boite3 = new Objet(585, 640, 62, 85, "Boîte", "C'est une boîte qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, true);
            Objet mallette = new Objet(310, 200, 70, 90, "Mallette", "C'est une mallette qui pourrait contenir des objets utiles.", false, Hitboxes.CARRE, false, true);
            Objet tiroir = new Objet(410, 650, 80, 50, "Tiroir", "C'est un tiroir qui pourrait contenir des objets utiles.", true, Hitboxes.CARRE, false, false);
            Objet bocalEtrange = new Objet(400, 530, 55, 112, "Bocal étrange", "C'est un bocal contenant une chose étrange.", false, Hitboxes.CARRE, false, false);
        ...
        Scene sacTelephone = new Scene("Sac Téléphone", "src/resources/sac téléphone.png", "C'est un sac contenant un téléphone, des médicaments, un tournevis et des serviettes. ");
            Objet telephone = new Objet(659, 444, 166, 285, "Téléphone", "C'est un téléphone", false, Hitboxes.CARRE, false, true);
            Objet medicaments = new Objet(270, 310, 210, 230, "Médicaments", "C'est des médicaments", false, Hitboxes.CARRE, false, true);
            Objet tournevis = new Objet(505, 345, 112, 300, "Tournevis", "C'est un tournevis", false, Hitboxes.CARRE, false, true);
            Objet serviettes = new Objet(525, 706, 343, 238, "Serviettes", "C'est des serviettes", false, Hitboxes.CARRE, false, true);
        ...
        Scene Mallette = new Scene("Malette", "src/resources/malettecléUSB.png", "C'est une mallette contenant des papiers et une clé USB. ");
            Objet cleUSB = new Objet(332, 595, 169, 100, "Clé USB", "C'est une clé USB qui pourrait contenir des informations.", false, Hitboxes.CARRE, true, false);
        ...
        Scene carnetTiroir = new Scene("Carnet Tiroir", "src/resources/carnettiroir.png", "C'est un tiroir contenant un carnet. ");
            Objet carnet = new Objet(490, 505, 495, 320, "Carnet", "C'est un carnet qui pourrait contenir des informations.", false, Hitboxes.CARRE, false, true);
        ...
        Scene digicode = new Scene("Digicode", "src/resources/digicode.png", "Pour sortir de la cave, il faut entrer le code :");
            Objet un = new Objet(438, 277, 77, 77, "1", "Le chiffre 1", true, Hitboxes.CARRE, false, false);
            Objet deux = new Objet(540, 277, 77, 77, "2", "Le chiffre 2", true, Hitboxes.CARRE, false, false);
            Objet trois = new Objet(644, 277, 77, 77, "3", "Le chiffre 3", true, Hitboxes.CARRE, false, false);
            Objet quatre = new Objet(435, 387, 77, 77, "4", "Le chiffre 4", true, Hitboxes.CARRE, false, false);
            Objet cinq = new Objet(541, 385, 77, 77, "5", "Le chiffre 5", true, Hitboxes.CARRE, false, false);
            Objet six = new Objet(644, 389, 77, 77, "6", "Le chiffre 6", true, Hitboxes.CARRE, false, false);
            Objet sept = new Objet(436, 490, 77, 77, "7", "Le chiffre 7", true, Hitboxes.CARRE, false, false);
            Objet huit = new Objet(543, 493, 77, 77, "8", "Le chiffre 8", true, Hitboxes.CARRE, false, false);
            Objet neuf = new Objet(646, 490, 77, 77, "9", "Le chiffre 9", true, Hitboxes.CARRE, false, false);
            Objet zero = new Objet(543, 596, 77, 77, "0", "Le chiffre 0", true, Hitboxes.CARRE, false, false);
            Objet valider = new Objet(541, 728, 260, 90, "Valider", "Valider le code", true, Hitboxes.CARRE, false, false);
